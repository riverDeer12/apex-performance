...
namespace ApexPerformance.API.Database.Migrations
{
    ...
    [Migration("20250626101635_AddedCanceledStatus00")]
    partial class AddedCanceledStatus00
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("70b5c6cb-d2b4-49ae-9959-cd6450439f55"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 6, 26, 12, 16, 34, 642, DateTimeKind.Unspecified).AddTicks(9828), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            FirstName = "Super",
                            IsDeleted = false,
                            LastName = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 6, 26, 12, 16, 34, 642, DateTimeKind.Unspecified).AddTicks(9832), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("b8f6cb70-ccf7-4a1c-8e6a-3f4a13c2735d"),
                            Category = "Appointments",
                            Description = "Allows progressing appointment.",
                            Name = "CanProgressAppointment"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 6, 26, 12, 16, 34, 642, DateTimeKind.Unspecified).AddTicks(9734), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            Description = "Role with all access.",
                            IsDeleted = false,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 6, 26, 12, 16, 34, 642, DateTimeKind.Unspecified).AddTicks(9744), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb")
                        });
                });
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 6, 26, 12, 16, 34, 642, DateTimeKind.Unspecified).AddTicks(8966), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 6, 26, 12, 16, 34, 642, DateTimeKind.Unspecified).AddTicks(9038), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            UserName = "superadmin"
                        });
                });
