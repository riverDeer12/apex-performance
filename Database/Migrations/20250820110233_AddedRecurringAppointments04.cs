...
{
    /// <inheritdoc />
    public partial class AddedRecurringAppointments04 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringAppointments_Coaches_CoachId",
                        column: x => x.CoachId,
                        principalTable: "Coaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringAppointments_TimeSlots_TimeSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringAppointments_ClientId",
                table: "RecurringAppointments",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringAppointments_CoachId",
                table: "RecurringAppointments",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringAppointments_TimeSlotId",
                table: "RecurringAppointments",
                column: "TimeSlotId");
        }
