...
namespace ApexPerformance.API.Database.Migrations
{
    ...
    [Migration("20250422191325_Initial00")]
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7133ccad-9e04-432c-970a-a45b2b6a86fe"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 4, 22, 21, 13, 25, 98, DateTimeKind.Unspecified).AddTicks(9580), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            FirstName = "Super",
                            IsDeleted = false,
                            LastName = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 4, 22, 21, 13, 25, 98, DateTimeKind.Unspecified).AddTicks(9590), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 4, 22, 21, 13, 25, 98, DateTimeKind.Unspecified).AddTicks(9520), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            Description = "Role with all access.",
                            IsDeleted = false,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 4, 22, 21, 13, 25, 98, DateTimeKind.Unspecified).AddTicks(9520), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb")
                        });
                });
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 4, 22, 21, 13, 25, 98, DateTimeKind.Unspecified).AddTicks(8990), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 4, 22, 21, 13, 25, 98, DateTimeKind.Unspecified).AddTicks(9050), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            UserName = "superadmin"
                        });
                });
