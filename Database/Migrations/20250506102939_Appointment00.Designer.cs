...
namespace ApexPerformance.API.Database.Migrations
{
    ...
    [Migration("20250506102939_Appointment00")]
    partial class Appointment00
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("31d62a6b-49fc-4bcd-91f4-e1c02f0fe737"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 12, 29, 38, 834, DateTimeKind.Unspecified).AddTicks(3800), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            FirstName = "Super",
                            IsDeleted = false,
                            LastName = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 12, 29, 38, 834, DateTimeKind.Unspecified).AddTicks(3810), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 12, 29, 38, 834, DateTimeKind.Unspecified).AddTicks(3750), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            Description = "Role with all access.",
                            IsDeleted = false,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 12, 29, 38, 834, DateTimeKind.Unspecified).AddTicks(3750), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb")
                        });
                });
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 12, 29, 38, 834, DateTimeKind.Unspecified).AddTicks(3320), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 5, 6, 12, 29, 38, 834, DateTimeKind.Unspecified).AddTicks(3380), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            UserName = "superadmin"
                        });
                });
