...
namespace ApexPerformance.API.Database.Migrations
{
    ...
    [Migration("20250512113445_appointmentTypes00")]
    partial class appointmentTypes00
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("98b3bf6e-eb92-47fc-993a-efc859904d79"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 12, 13, 34, 44, 978, DateTimeKind.Unspecified).AddTicks(8340), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            FirstName = "Super",
                            IsDeleted = false,
                            LastName = "Admin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 5, 12, 13, 34, 44, 978, DateTimeKind.Unspecified).AddTicks(8350), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 12, 13, 34, 44, 978, DateTimeKind.Unspecified).AddTicks(8290), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            Description = "Role with all access.",
                            IsDeleted = false,
                            Name = "SuperAdmin",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 5, 12, 13, 34, 44, 978, DateTimeKind.Unspecified).AddTicks(8300), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb")
                        });
                });
            ...
            modelBuilder.Entity("ApexPerformance.API.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 5, 12, 13, 34, 44, 978, DateTimeKind.Unspecified).AddTicks(7770), new TimeSpan(0, 2, 0, 0, 0)),
                            CreatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 5, 12, 13, 34, 44, 978, DateTimeKind.Unspecified).AddTicks(7840), new TimeSpan(0, 2, 0, 0, 0)),
                            UpdatedBy = new Guid("5604e898-cd94-476b-8b86-9aa3a87cc9bb"),
                            UserName = "superadmin"
                        });
                });
