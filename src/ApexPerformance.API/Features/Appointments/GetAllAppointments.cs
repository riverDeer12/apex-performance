...
public class GetAllAppointmentsEndpoint: EndpointWithoutRequest<List<AppointmentDataDto>>
{
    private readonly ApexPerformanceContext _context;
    private readonly ICurrentUserService _currentUserService;

    public GetAllAppointmentsEndpoint(ApexPerformanceContext context, ICurrentUserService currentUserService)
    {
        _context = context;
    ...
    public override async Task HandleAsync(CancellationToken cancellationToken)
    {
        ...
        var appointmentsResult = new List<AppointmentDataDto>();
        ...
        foreach (var appointment in appointments)
        {
            ...
            appointmentsResult.Add(appointmentResponse);
        }

        await SendAsync(appointmentsResult, cancellation: cancellationToken);
    }
