...
public class CreateClientEndpoint : Endpoint<CreateClientRequest, CreateClientResponse>
{
    ...
    public override async Task HandleAsync(CreateClientRequest request, CancellationToken cancellationToken)
    {
        ...
        await AddClientCoaches(newClient, request.Coaches, cancellationToken);

        _emailService.SendClientCredentialsEmail(newClient, autoGeneratedPassword);
    ...
    private async Task AddClientCoaches(Client newClient, List<Guid> coachesIds, CancellationToken cancellationToken)
    {
